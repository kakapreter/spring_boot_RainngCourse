...
CREATE TABLE `rc_admin`  (
  ...
  `admin_username` varchar(25) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '用户名',
  `admin_password` char(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '密码',
  `admin_privilege` int(11) NOT NULL COMMENT '',
...
CREATE TABLE `rc_course`  (
  ...
  `course_exam_date` datetime NULL DEFAULT '1999-01-01 01:01:01' COMMENT '考试时间',
...
CREATE TABLE `rc_student`  (
  ...
  `student_birthday` datetime NULL DEFAULT '1999-01-01 01:01:01'  COMMENT '生日',
  `student_sex` tinyint(1) UNSIGNED NOT NULL COMMENT '性别',
  `student_last_login_time` datetime NULL DEFAULT '1999-01-01 01:01:01' COMMENT '最近登录时间',
